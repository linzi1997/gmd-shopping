...
public interface UsersRepository extends JpaRepository<Users, Integer>,JpaSpecificationExecutor<Users> {
	 ...
	 * @return 成功返回登录用户的完整的信息，失败返回null
	 */
	@Query("select new com.springcloud.entity.Users(u.userId,u.userName,u.userIdNumber,u.userPassword,u.userSex,u.userPhone,u.userSite,u.userBirthday,u.userEmail,u.userHphoto,u.jdictionId,u.userStatus)"
	 ...
	 */
	@Modifying
	@Query("update Users u set u.userIdNumber=:#{#users.userIdNumber},u.userSex=:#{#users.userSex},u.userPhone=:#{#users.userPhone},u.userBirthday=:#{#users.userBirthday},u.userEmail=:#{#users.userEmail},u.userSite=:#{#users.userSite} where u.userId=:#{#users.userId}")
